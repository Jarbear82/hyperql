LANGUAGE_NAME := tree-sitter-hyperql
HOMEPAGE_URL := https://github.com/jarbear82/hyperql
VERSION := 0.14.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/hyperql '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/hyperql
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/hyperql
